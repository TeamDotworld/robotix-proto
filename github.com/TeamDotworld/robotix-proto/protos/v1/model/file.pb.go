...
var file_protos_model_v1_file_proto_rawDesc = []byte{
	...
	0x42, 0x38, 0x5a, 0x36, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
func file_protos_model_v1_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_model_v1_file_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*File); i {
			case 0:
				return &v.state
			case 1:

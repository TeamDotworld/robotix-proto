...
type AgentClient interface {
	...
	GetActionRequestStream(ctx context.Context, in *GetActionRequestStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetActionRequestStreamResponse], error)
	...
	ReceiveRosMessages(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest], error)
...
func (c *agentClient) GetActionRequestStream(ctx context.Context, in *GetActionRequestStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetActionRequestStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[2], Agent_GetActionRequestStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetActionRequestStreamRequest, GetActionRequestStreamResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Agent_GetActionRequestStreamClient = grpc.ServerStreamingClient[GetActionRequestStreamResponse]
...
func (c *agentClient) StreamData(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamDataResponse, StreamDataRequest], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Agent_StreamDataClient = grpc.BidiStreamingClient[StreamDataResponse, StreamDataRequest]

func (c *agentClient) ReceiveRosMessages(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[6], Agent_ReceiveRosMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Agent_ReceiveRosMessagesClient = grpc.BidiStreamingClient[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]
...
type AgentServer interface {
	...
	GetActionRequestStream(*GetActionRequestStreamRequest, grpc.ServerStreamingServer[GetActionRequestStreamResponse]) error
	...
	// gets ros messages which needs to be published such as command velocity
	// messages, camera control messages from agent and then pubslishes to ros.
	ReceiveRosMessages(grpc.BidiStreamingServer[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]) error
	// Get rtc signal from Rcc server to agent
...
func (UnimplementedAgentServer) AuthenticateAgent(context.Context, *AuthRequest) (*AuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthenticateAgent not implemented")
}
func (UnimplementedAgentServer) GetDeviceSpecifications(context.Context, *SpecsRequest) (*SpecsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDeviceSpecifications not implemented")
}
func (UnimplementedAgentServer) GetAgentConfiguration(context.Context, *GetAgentConfigurationRequest) (*GetAgentConfigurationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAgentConfiguration not implemented")
}
...
func (UnimplementedAgentServer) GetCommandRequestStream(*GetCommandRequestStreamRequest, grpc.ServerStreamingServer[GetCommandRequestStreamResponse]) error {
	return status.Error(codes.Unimplemented, "method GetCommandRequestStream not implemented")
}
func (UnimplementedAgentServer) SendCommandResponse(context.Context, *SendCommandResponseRequest) (*SendCommandResponseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendCommandResponse not implemented")
}
func (UnimplementedAgentServer) GetActionRequestStream(*GetActionRequestStreamRequest, grpc.ServerStreamingServer[GetActionRequestStreamResponse]) error {
	return status.Error(codes.Unimplemented, "method GetActionRequestStream not implemented")
}
func (UnimplementedAgentServer) SendActionResponse(context.Context, *SendActionResponseRequest) (*SendActionResponseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendActionResponse not implemented")
}
func (UnimplementedAgentServer) GetSubscriptionRequestStream(*GetSubscriptionRequestStreamRequest, grpc.ServerStreamingServer[GetSubscriptionRequestStreamResponse]) error {
	return status.Error(codes.Unimplemented, "method GetSubscriptionRequestStream not implemented")
}
func (UnimplementedAgentServer) SendSubscriptionResponse(context.Context, *SendSubscriptionResponseRequest) (*SendSubscriptionResponseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendSubscriptionResponse not implemented")
}
func (UnimplementedAgentServer) SendCommandResponseStream(grpc.BidiStreamingServer[SendCommandResponseRequest, SendCommandResponseResponse]) error {
	return status.Error(codes.Unimplemented, "method SendCommandResponseStream not implemented")
}
func (UnimplementedAgentServer) PostData(context.Context, *model.Datapoint) (*PostDataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PostData not implemented")
}
func (UnimplementedAgentServer) PostMultiData(context.Context, *PostMultiDataRequest) (*PostMultiDataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PostMultiData not implemented")
}
func (UnimplementedAgentServer) StreamData(grpc.BidiStreamingServer[StreamDataResponse, StreamDataRequest]) error {
	return status.Error(codes.Unimplemented, "method StreamData not implemented")
}
func (UnimplementedAgentServer) ReceiveRosMessages(grpc.BidiStreamingServer[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]) error {
	return status.Error(codes.Unimplemented, "method ReceiveRosMessages not implemented")
}
func (UnimplementedAgentServer) GetRtcSignal(grpc.BidiStreamingServer[GetRtcSignalResponse, GetRtcSignalRequest]) error {
	return status.Error(codes.Unimplemented, "method GetRtcSignal not implemented")
}
func (UnimplementedAgentServer) SendSignalData(context.Context, *SignalDataRequest) (*SignalDataResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendSignalData not implemented")
}
...
func _Agent_GetActionRequestStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AgentServer).GetActionRequestStream(m, &grpc.GenericServerStream[GetActionRequestStreamRequest, GetActionRequestStreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Agent_GetActionRequestStreamServer = grpc.ServerStreamingServer[GetActionRequestStreamResponse]
...
func _Agent_StreamData_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AgentServer).StreamData(&grpc.GenericServerStream[StreamDataResponse, StreamDataRequest]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Agent_StreamDataServer = grpc.BidiStreamingServer[StreamDataResponse, StreamDataRequest]

func _Agent_ReceiveRosMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AgentServer).ReceiveRosMessages(&grpc.GenericServerStream[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Agent_ReceiveRosMessagesServer = grpc.BidiStreamingServer[ReceiveRosMessagesResponse, ReceiveRosMessagesRequest]

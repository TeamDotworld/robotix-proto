...
const (
	...
	CommandStreamCommands_ANNOUNCE               CommandStreamCommands = 14 // Fire-and-forget advisory status text pushed to a robot (traffic holds, occupied goal, ...). Never affects navigation.
)
...
const file_protos_fleet_manager_v1_fleet_manager_proto_rawDesc = "" +
	...
	"\bPLATFORM\x10\r\x12\f\n" +
	"\bANNOUNCE\x10\x0e*\xf7\x04\n" +
	...
	"\x13UPDATE_ROBOT_CONFIG\x10\x1e*l\n" +
...
var file_protos_fleet_manager_v1_fleet_manager_proto_goTypes = []any{
	...
	(*CommandStreamRequest)(nil),    // 4: v1.fleet_manager.CommandStreamRequest
	(*CommandStreamResponse)(nil),   // 5: v1.fleet_manager.CommandStreamResponse
...
var file_protos_fleet_manager_v1_fleet_manager_proto_depIdxs = []int32{
	...
	4,  // 10: v1.fleet_manager.FleetManager.HerdCommandStream:input_type -> v1.fleet_manager.CommandStreamRequest
	...
	5,  // 16: v1.fleet_manager.FleetManager.HerdCommandStream:output_type -> v1.fleet_manager.CommandStreamResponse

...
var file_protos_model_v1_text_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_protos_model_v1_text_proto_goTypes = []interface{}{
...
func file_protos_model_v1_text_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_model_v1_text_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Text); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protos_model_v1_text_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Json); i {
			case 0:
				return &v.state
			case 1:

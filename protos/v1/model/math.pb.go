...
type Pose struct {
	...
	Covariance []float64 `protobuf:"fixed64,3,rep,packed,name=covariance,proto3" json:"covariance,omitempty"`
}
...
func (x *Pose) GetCovariance() []float64 {
	if x != nil {
		return x.Covariance
	}
	return nil
...
func (x *Pose_Pose) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Pose_Pose) ProtoMessage() {}

func (x *Pose_Pose) ProtoReflect() protoreflect.Message {
	mi := &file_protos_model_v1_math_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Pose_Pose.ProtoReflect.Descriptor instead.
func (*Pose_Pose) Descriptor() ([]byte, []int) {
	return file_protos_model_v1_math_proto_rawDescGZIP(), []int{7, 0}
}

func (x *Pose_Pose) GetPosition() *Position {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *Pose_Pose) GetOrientation() *Orientation {
	if x != nil {
...
var file_protos_model_v1_math_proto_rawDesc = []byte{
	...
	,
...
var file_protos_model_v1_math_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_protos_model_v1_math_proto_goTypes = []interface{}{
	...
	(*Header)(nil),          // 12: v1.model.Header
	(*Stamp)(nil),           // 13: v1.model.stamp
	(*Orientation)(nil),     // 14: v1.model.Orientation
	(*Position)(nil),        // 15: v1.model.Position
	(*Pose_Pose)(nil),       // 16: v1.model.Pose.Pose
}
var file_protos_model_v1_math_proto_depIdxs = []int32{
	...
	13, // 7: v1.model.Header.stamp:type_name -> v1.model.stamp
	15, // 8: v1.model.Pose.Pose.position:type_name -> v1.model.Position
	14, // 9: v1.model.Pose.Pose.orientation:type_name -> v1.model.Orientation

...
type InitialPose struct {
	...
	Covariance []float32 `protobuf:"fixed32,2,rep,packed,name=covariance,proto3" json:"covariance,omitempty"`
}
...
func (x *InitialPose) GetCovariance() []float32 {
	if x != nil {
		return x.Covariance
	}
	return nil
...
var file_protos_model_v1_math_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x02, 0x52, 0x0a, 0x63, 0x6f,

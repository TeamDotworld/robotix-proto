...
func (x *Datapoint) GetState() *State {
	if x, ok := x.GetData().(*Datapoint_State); ok {
		return x.State
	}
	return nil
}

func (x *Datapoint) GetRobotPose() *RobotPose {
	if x, ok := x.GetData().(*Datapoint_RobotPose); ok {
		return x.RobotPose
	}
	return nil
}

func (x *Datapoint) GetPlanState() *PlanState {
	if x, ok := x.GetData().(*Datapoint_PlanState); ok {
		return x.PlanState
	}
	return nil
}
...
type Datapoint_State struct {
	State *State `protobuf:"bytes,20,opt,name=state,proto3,oneof"`
}

type Datapoint_RobotPose struct {
	RobotPose *RobotPose `protobuf:"bytes,21,opt,name=robot_pose,json=robotPose,proto3,oneof"`
}

type Datapoint_PlanState struct {
	PlanState *PlanState `protobuf:"bytes,22,opt,name=plan_state,json=planState,proto3,oneof"`
}
...
func (*Datapoint_State) isDatapoint_Data() {}

func (*Datapoint_RobotPose) isDatapoint_Data() {}

func (*Datapoint_PlanState) isDatapoint_Data() {}
...
var file_protos_model_v1_datapoint_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x08, 0x0a, 0x09, 0x44, 0x61, 0x74, 0x61,
	...
	,
	...
	,
...
var file_protos_model_v1_datapoint_proto_goTypes = []interface{}{
	...
	(*State)(nil),            // 18: v1.model.State
	(*RobotPose)(nil),        // 19: v1.model.RobotPose
	(*PlanState)(nil),        // 20: v1.model.PlanState
	(*Twist)(nil),            // 21: v1.model.Twist
	(*Transform)(nil),        // 22: v1.model.Transform
	(*Point)(nil),            // 23: v1.model.Point
	(*GoalID)(nil),           // 24: v1.model.GoalID
}
var file_protos_model_v1_datapoint_proto_depIdxs = []int32{
	...
	18, // 15: v1.model.Datapoint.state:type_name -> v1.model.State
	19, // 16: v1.model.Datapoint.robot_pose:type_name -> v1.model.RobotPose
	20, // 17: v1.model.Datapoint.plan_state:type_name -> v1.model.PlanState
	3,  // 18: v1.model.ControlDatapoint.tags:type_name -> v1.model.ControlDatapoint.TagsEntry
	4,  // 19: v1.model.ControlDatapoint.text:type_name -> v1.model.Text
	5,  // 20: v1.model.ControlDatapoint.numeric:type_name -> v1.model.Numeric
	7,  // 21: v1.model.ControlDatapoint.bitset:type_name -> v1.model.Bitset
	21, // 22: v1.model.ControlDatapoint.twist:type_name -> v1.model.Twist
	22, // 23: v1.model.ControlDatapoint.pose:type_name -> v1.model.Transform
	23, // 24: v1.model.ControlDatapoint.point:type_name -> v1.model.Point
	24, // 25: v1.model.ControlDatapoint.goal_id:type_name -> v1.model.GoalID
...
func file_protos_model_v1_datapoint_proto_init() {
	...
	file_protos_model_v1_datapoint_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Datapoint_Raw)(nil),
		(*Datapoint_State)(nil),
		(*Datapoint_RobotPose)(nil),
		(*Datapoint_PlanState)(nil),
	}

...
var file_protos_rcc_v1_rcc_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xfe, 0x05, 0x0a, 0x05,
...
var file_protos_rcc_v1_rcc_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_protos_rcc_v1_rcc_proto_goTypes = []interface{}{
	...
	(*model.AgentConfigurationStore)(nil),   // 15: v1.model.AgentConfigurationStore
	(*model.CommandResponse)(nil),           // 16: v1.model.CommandResponse
	(*model.CommandRequest)(nil),            // 17: v1.model.CommandRequest
	(*model.Datapoint)(nil),                 // 18: v1.model.Datapoint
}
var file_protos_rcc_v1_rcc_proto_depIdxs = []int32{
	15, // 0: v1.rcc.GetAgentConfigurationResponse.configuration:type_name -> v1.model.AgentConfigurationStore
	16, // 1: v1.rcc.SendCommandResponseRequest.response:type_name -> v1.model.CommandResponse
	7,  // 2: v1.rcc.SendCommandResponseResponse.error:type_name -> v1.rcc.Error
	17, // 3: v1.rcc.GetCommandRequestStreamResponse.request:type_name -> v1.model.CommandRequest
	18, // 4: v1.rcc.PostMultiDataRequest.data:type_name -> v1.model.Datapoint
	0,  // 5: v1.rcc.Agent.AuthenticateAgent:input_type -> v1.rcc.AuthRequest
	2,  // 6: v1.rcc.Agent.GetAgentConfiguration:input_type -> v1.rcc.GetAgentConfigurationRequest
	5,  // 7: v1.rcc.Agent.Health:input_type -> v1.rcc.HealthResponse
	9,  // 8: v1.rcc.Agent.GetCommandRequestStream:input_type -> v1.rcc.GetCommandRequestStreamRequest
	6,  // 9: v1.rcc.Agent.SendCommandResponse:input_type -> v1.rcc.SendCommandResponseRequest
	6,  // 10: v1.rcc.Agent.SendCommandResponseStream:input_type -> v1.rcc.SendCommandResponseRequest
	18, // 11: v1.rcc.Agent.PostData:input_type -> v1.model.Datapoint
	12, // 12: v1.rcc.Agent.PostMultiData:input_type -> v1.rcc.PostMultiDataRequest
	18, // 13: v1.rcc.Agent.StreamData:input_type -> v1.model.Datapoint
	1,  // 14: v1.rcc.Agent.AuthenticateAgent:output_type -> v1.rcc.AuthResponse
	3,  // 15: v1.rcc.Agent.GetAgentConfiguration:output_type -> v1.rcc.GetAgentConfigurationResponse
	4,  // 16: v1.rcc.Agent.Health:output_type -> v1.rcc.HealthRequest
	10, // 17: v1.rcc.Agent.GetCommandRequestStream:output_type -> v1.rcc.GetCommandRequestStreamResponse
	8,  // 18: v1.rcc.Agent.SendCommandResponse:output_type -> v1.rcc.SendCommandResponseResponse
	8,  // 19: v1.rcc.Agent.SendCommandResponseStream:output_type -> v1.rcc.SendCommandResponseResponse
	11, // 20: v1.rcc.Agent.PostData:output_type -> v1.rcc.PostDataResponse
	13, // 21: v1.rcc.Agent.PostMultiData:output_type -> v1.rcc.PostMultiDataResponse
	14, // 22: v1.rcc.Agent.StreamData:output_type -> v1.rcc.StreamDataResponse
...
func (c *agentClient) SendCommandResponseStream(ctx context.Context, opts ...grpc.CallOption) (Agent_SendCommandResponseStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Agent_serviceDesc.Streams[2], "/v1.rcc.Agent/SendCommandResponseStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) StreamData(ctx context.Context, opts ...grpc.CallOption) (Agent_StreamDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Agent_serviceDesc.Streams[3], "/v1.rcc.Agent/StreamData", opts...)
	if err != nil {
		return nil, err
	}

...
var file_protos_rcc_v1_rcc_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xac, 0x05, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x68, 0x0a, 0x19, 0x53, 0x65,
	...
	0x22, 0x00, 0x28, 0x01, 0x12, 0x3b, 0x0a, 0x08, 0x50, 0x6f, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61,
	...
	0x22, 0x00, 0x28, 0x01, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_protos_rcc_v1_rcc_proto_depIdxs = []int32{
	...
	6,  // 8: v1.rcc.Agent.SendCommandResponseStream:input_type -> v1.rcc.SendCommandResponseRequest
	15, // 9: v1.rcc.Agent.PostData:input_type -> v1.model.Datapoint
	15, // 10: v1.rcc.Agent.StreamData:input_type -> v1.model.Datapoint
	1,  // 11: v1.rcc.Agent.AuthenticateAgent:output_type -> v1.rcc.AuthResponse
	3,  // 12: v1.rcc.Agent.GetAgentConfiguration:output_type -> v1.rcc.GetAgentConfigurationResponse
	4,  // 13: v1.rcc.Agent.Health:output_type -> v1.rcc.HealthRequest
	9,  // 14: v1.rcc.Agent.GetCommandRequestStream:output_type -> v1.rcc.GetCommandRequestStreamResponse
	7,  // 15: v1.rcc.Agent.SendCommandResponse:output_type -> v1.rcc.SendCommandResponseResponse
	7,  // 16: v1.rcc.Agent.SendCommandResponseStream:output_type -> v1.rcc.SendCommandResponseResponse
	10, // 17: v1.rcc.Agent.PostData:output_type -> v1.rcc.PostDataResponse
	11, // 18: v1.rcc.Agent.StreamData:output_type -> v1.rcc.StreamDataResponse
...
func (x *agentSendCommandResponseStreamClient) CloseAndRecv() (*SendCommandResponseResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (x *agentSendCommandResponseStreamServer) SendAndClose(m *SendCommandResponseResponse) error {
	return x.ServerStream.SendMsg(m)
}

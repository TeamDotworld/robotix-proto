...
var file_protos_rcc_v1_rcc_proto_goTypes = []interface{}{
	...
	(*model.Topics)(nil),                         // 21: v1.model.Topics
	(*model.StreamConfiguration)(nil),            // 22: v1.model.StreamConfiguration
}
var file_protos_rcc_v1_rcc_proto_depIdxs = []int32{
	...
	21, // 5: v1.rcc.GetSubscriptionRequestStreamResponse.topics:type_name -> v1.model.Topics
	22, // 6: v1.rcc.GetSubscriptionRequestStreamRequest.topic:type_name -> v1.model.StreamConfiguration
	0,  // 7: v1.rcc.Agent.AuthenticateAgent:input_type -> v1.rcc.AuthRequest
	2,  // 8: v1.rcc.Agent.GetAgentConfiguration:input_type -> v1.rcc.GetAgentConfigurationRequest
	5,  // 9: v1.rcc.Agent.Health:input_type -> v1.rcc.HealthResponse
	9,  // 10: v1.rcc.Agent.GetCommandRequestStream:input_type -> v1.rcc.GetCommandRequestStreamRequest
	15, // 11: v1.rcc.Agent.GetSubscriptionRequestStream:input_type -> v1.rcc.GetSubscriptionRequestStreamResponse
	6,  // 12: v1.rcc.Agent.SendCommandResponse:input_type -> v1.rcc.SendCommandResponseRequest
	6,  // 13: v1.rcc.Agent.SendCommandResponseStream:input_type -> v1.rcc.SendCommandResponseRequest
	20, // 14: v1.rcc.Agent.PostData:input_type -> v1.model.Datapoint
	12, // 15: v1.rcc.Agent.PostMultiData:input_type -> v1.rcc.PostMultiDataRequest
	20, // 16: v1.rcc.Agent.StreamData:input_type -> v1.model.Datapoint
	1,  // 17: v1.rcc.Agent.AuthenticateAgent:output_type -> v1.rcc.AuthResponse
	3,  // 18: v1.rcc.Agent.GetAgentConfiguration:output_type -> v1.rcc.GetAgentConfigurationResponse
	4,  // 19: v1.rcc.Agent.Health:output_type -> v1.rcc.HealthRequest
	10, // 20: v1.rcc.Agent.GetCommandRequestStream:output_type -> v1.rcc.GetCommandRequestStreamResponse
	16, // 21: v1.rcc.Agent.GetSubscriptionRequestStream:output_type -> v1.rcc.GetSubscriptionRequestStreamRequest
	8,  // 22: v1.rcc.Agent.SendCommandResponse:output_type -> v1.rcc.SendCommandResponseResponse
	8,  // 23: v1.rcc.Agent.SendCommandResponseStream:output_type -> v1.rcc.SendCommandResponseResponse
	11, // 24: v1.rcc.Agent.PostData:output_type -> v1.rcc.PostDataResponse
	13, // 25: v1.rcc.Agent.PostMultiData:output_type -> v1.rcc.PostMultiDataResponse
	14, // 26: v1.rcc.Agent.StreamData:output_type -> v1.rcc.StreamDataResponse

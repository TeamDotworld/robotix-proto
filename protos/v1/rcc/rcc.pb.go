...
var file_protos_rcc_v1_rcc_proto_rawDesc = []byte{
	...
	0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xac, 0x05, 0x0a, 0x05, 0x41, 0x67,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x68,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x3b, 0x0a, 0x08, 0x50, 0x6f, 0x73, 0x74,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68,
...
var file_protos_rcc_v1_rcc_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_protos_rcc_v1_rcc_proto_goTypes = []interface{}{
	...
	(*StreamDataResponse)(nil),              // 12: v1.rcc.StreamDataResponse
	(*model.AgentConfigurationStore)(nil),   // 13: v1.model.AgentConfigurationStore
...
var file_protos_rcc_v1_rcc_proto_depIdxs = []int32{
	13, // 0: v1.rcc.GetAgentConfigurationResponse.configuration:type_name -> v1.model.AgentConfigurationStore
	14, // 1: v1.rcc.SendCommandResponseRequest.response:type_name -> v1.model.CommandResponse
	7,  // 2: v1.rcc.SendCommandResponseResponse.error:type_name -> v1.rcc.Error
	15, // 3: v1.rcc.GetCommandRequestStreamResponse.request:type_name -> v1.model.CommandRequest
	0,  // 4: v1.rcc.Agent.AuthenticateAgent:input_type -> v1.rcc.AuthRequest
	2,  // 5: v1.rcc.Agent.GetAgentConfiguration:input_type -> v1.rcc.GetAgentConfigurationRequest
	5,  // 6: v1.rcc.Agent.Health:input_type -> v1.rcc.HealthResponse
	9,  // 7: v1.rcc.Agent.GetCommandRequestStream:input_type -> v1.rcc.GetCommandRequestStreamRequest
	6,  // 8: v1.rcc.Agent.SendCommandResponse:input_type -> v1.rcc.SendCommandResponseRequest
	6,  // 9: v1.rcc.Agent.SendCommandResponseStream:input_type -> v1.rcc.SendCommandResponseRequest
	16, // 10: v1.rcc.Agent.PostData:input_type -> v1.model.Datapoint
	16, // 11: v1.rcc.Agent.StreamData:input_type -> v1.model.Datapoint
	1,  // 12: v1.rcc.Agent.AuthenticateAgent:output_type -> v1.rcc.AuthResponse
	3,  // 13: v1.rcc.Agent.GetAgentConfiguration:output_type -> v1.rcc.GetAgentConfigurationResponse
	4,  // 14: v1.rcc.Agent.Health:output_type -> v1.rcc.HealthRequest
	10, // 15: v1.rcc.Agent.GetCommandRequestStream:output_type -> v1.rcc.GetCommandRequestStreamResponse
	8,  // 16: v1.rcc.Agent.SendCommandResponse:output_type -> v1.rcc.SendCommandResponseResponse
	8,  // 17: v1.rcc.Agent.SendCommandResponseStream:output_type -> v1.rcc.SendCommandResponseResponse
	11, // 18: v1.rcc.Agent.PostData:output_type -> v1.rcc.PostDataResponse
	12, // 19: v1.rcc.Agent.StreamData:output_type -> v1.rcc.StreamDataResponse
